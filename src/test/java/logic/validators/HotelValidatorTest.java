...
public class HotelValidatorTest {
    ...
    public void testValidHotel() {
        HotelValidator hotelValidator = new HotelValidator("Example Hotel", LocalDate.now().minusDays(1), "Valid description",
                "Country", "City", "Street", "12345", "1", "valid@example.com", "example.com", "123456789", "1234567890123456", true);
    ...
    public void testInvalidEmail() {
        HotelValidator hotelValidator = new HotelValidator("Example Hotel", LocalDate.now().minusDays(1), "Valid description",
                "Country", "City", "Street", "12345", "1", "aaa", "example.com", "123456789", "1234567890123456", true);
    ...
    public void testInvalidWebsite() {
        HotelValidator hotelValidator = new HotelValidator("Example Hotel", LocalDate.now().minusDays(1), "Valid description",
                "Country", "City", "Street", "12345", "1", "valid@example.com", "in", "123456789", "1234567890123456", true);
    ...
    public void testInvalidPhoneNumber() {
        HotelValidator hotelValidator = new HotelValidator("Example Hotel", LocalDate.now().minusDays(1), "Valid description",
                "Country", "City", "Street", "12345", "1", "valid@example.com", "example.com", "invalid", "1234567890123456", true);
    ...
    public void testInvalidBankAccountNumber() {
        HotelValidator hotelValidator = new HotelValidator("Example Hotel", LocalDate.now().minusDays(1), "Valid description",
                "Country", "City", "Street", "12345", "1", "valid@example.com", "example.com", "123456789", "123456789012345678901234567890123456", true);
